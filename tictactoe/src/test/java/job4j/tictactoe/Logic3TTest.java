...
public class Logic3TTest {
    ...
    @Test
    public void whenHasXWinnerStartX0StartY1DeltaX1DeltaY0() {
        Figure3T[][] table = {
                {new Figure3T(true), new Figure3T(), new Figure3T()},
                {new Figure3T(true), new Figure3T(), new Figure3T()},
                {new Figure3T(true), new Figure3T(), new Figure3T()},
    ...
    @Test
    public void whenHasXWinnerStartX0StartY2DeltaX1DeltaY0() {
        Figure3T[][] table = {
                {new Figure3T(), new Figure3T(), new Figure3T(true)},
                {new Figure3T(), new Figure3T(), new Figure3T(true)},
                {new Figure3T(), new Figure3T(), new Figure3T(true)},
    ...
    @Test
    public void whenHasXWinnerStartX0StartY0DeltaX0DeltaY1() {
        Figure3T[][] table = {
    ...
    @Test
    public void whenHasOWinnerCenter() {
        Figure3T[][] table = {
    ...
    @Test
    public void whenHasOWinnerBottom() {
        Figure3T[][] table = {
                {new Figure3T(), new Figure3T(), new Figure3T()},
                {new Figure3T(), new Figure3T(), new Figure3T()},
